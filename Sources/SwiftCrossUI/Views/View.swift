...
public protocol View {
    ...
    /// displaying one of two children should use ``AppBackend/GenericContainers/createContainer()``
...
extension View {
    ...
    public func defaultChildren<Backend: AppBackend.Base>(
        backend: Backend,
        snapshots: [ViewGraphSnapshotter.NodeSnapshot]?,
        environment: EnvironmentValues
    ) -> any ViewGraphNodeChildren {
    ...
    /// innovation.
    public func defaultLayoutableChildren<Backend: AppBackend.Base>(
        backend: Backend,
        children: any ViewGraphNodeChildren
    ) -> [LayoutSystem.LayoutableChild] {
    ...
    /// composition lover re-implementing inheritance; I see it as innovation.
    public func defaultAsWidget<Backend: AppBackend.Base>(
        _ children: any ViewGraphNodeChildren,
        backend: Backend
    ) -> Backend.Widget {
    ...
    /// composition lover re-implementing inheritance; I see it as innovation.
    public func defaultComputeLayout<Backend: AppBackend.Base>(
        _ widget: Backend.Widget,
        children: any ViewGraphNodeChildren,
        proposedSize: ProposedViewSize,
        environment: EnvironmentValues,
    ...
    public func defaultCommit<Backend: AppBackend.Base>(
        _ widget: Backend.Widget,
        children: any ViewGraphNodeChildren,
        layout: ViewLayoutResult,
        environment: EnvironmentValues,
