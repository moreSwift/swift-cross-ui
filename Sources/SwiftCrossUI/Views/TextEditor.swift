...
public struct TextEditor: ElementaryView {
    ...
    func asWidget<Backend: AppBackend_TextEditor>(backend: Backend) -> Backend.Widget {
        backend.createTextEditor()
    }

    func computeLayout<Backend: AppBackend_Text>(
    ...
    func commit<Backend: AppBackend_TextEditor>(
        _ widget: Backend.Widget,
