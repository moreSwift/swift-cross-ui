...
public class AnyViewGraphNode<NodeView: View> {
    ...
    private var _getBackend: () -> any AppBackend.Base
    ...
    public init<Backend: AppBackend.Base>(_ node: ViewGraphNode<NodeView, Backend>) {
        self.node = node
    ...
    public convenience init<Backend: AppBackend.Base>(
        for view: NodeView,
        backend: Backend,
