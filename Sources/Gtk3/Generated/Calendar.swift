...
open class Calendar: Widget {
    ...
    open override func registerSignals() {
        ...
        addSignal(
            name: "notify::detail-height-rows",
        ...
        addSignal(
            name: "notify::detail-width-chars",
