...
open class FileChooserNative: NativeDialog, FileChooser {
    ...
    open override func registerSignals() {
        ...
        addSignal(
            name: "notify::do-overwrite-confirmation",
        ...
        addSignal(
            name: "notify::preview-widget-active",
