...
open class Entry: Widget, CellEditable, Editable {
    ...
    open override func didMoveToParent() {
        ...
        let handler4: @convention(c) (
            UnsafeMutableRawPointer, GtkDeleteType, Int, UnsafeMutableRawPointer
        ) -> Void = { _, value1, value2, data in
            SignalBox2<GtkDeleteType, Int>.run(data, value1, value2)
        }

        addSignal(name: "delete-from-cursor", handler: gCallback(handler4)) { [weak self] (
            param0: GtkDeleteType,
            param1: Int
        ) in
            guard let self else { return }
        ...
        addSignal(name: "icon-press", handler: gCallback(handler5)) { [weak self] (
            param0: GtkEntryIconPosition,
            param1: GdkEvent
        ) in
            guard let self else { return }
        ...
        addSignal(name: "icon-release", handler: gCallback(handler6)) { [weak self] (
            param0: GtkEntryIconPosition,
            param1: GdkEvent
        ) in
            guard let self else { return }
        ...
        addSignal(name: "move-cursor", handler: gCallback(handler9)) { [weak self] (
        ...
        addSignal(name: "delete-text", handler: gCallback(handler16)) { [weak self] (
            param0: Int,
            param1: Int
        ) in
            guard let self else { return }
        ...
        addSignal(name: "insert-text", handler: gCallback(handler17)) { [weak self] (
        ...
        addSignal(
            name: "notify::enable-emoji-completion",
        ...
        addSignal(
            ...
            handler: gCallback(handler30)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyInputPurpose?(self, param0)
        }

        let handler31: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::invisible-char",
            handler: gCallback(handler31)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyInvisibleCharacter?(self, param0)
        }

        let handler32: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::invisible-char-set",
            handler: gCallback(handler32)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyInvisibleCharacterSet?(self, param0)
        }

        let handler33: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::max-length",
            handler: gCallback(handler33)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyMaxLength?(self, param0)
        }

        let handler34: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            ...
            handler: gCallback(handler34)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyMaxWidthChars?(self, param0)
        }

        let handler35: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::overwrite-mode",
            handler: gCallback(handler35)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyOverwriteMode?(self, param0)
        }

        let handler36: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::placeholder-text",
            handler: gCallback(handler36)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPlaceholderText?(self, param0)
        }

        let handler37: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::populate-all",
            handler: gCallback(handler37)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPopulateAll?(self, param0)
        }

        let handler38: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::primary-icon-activatable",
            handler: gCallback(handler38)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPrimaryIconActivatable?(self, param0)
        }

        let handler39: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::primary-icon-gicon",
            handler: gCallback(handler39)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPrimaryIconGicon?(self, param0)
        }

        let handler40: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::primary-icon-name",
            handler: gCallback(handler40)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPrimaryIconName?(self, param0)
        }

        let handler41: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::primary-icon-pixbuf",
            handler: gCallback(handler41)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPrimaryIconPixbuf?(self, param0)
        }

        let handler42: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::primary-icon-sensitive",
            handler: gCallback(handler42)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPrimaryIconSensitive?(self, param0)
        }

        let handler43: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::primary-icon-stock",
            handler: gCallback(handler43)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPrimaryIconStock?(self, param0)
        }

        let handler44: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::primary-icon-storage-type",
            handler: gCallback(handler44)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPrimaryIconStorageType?(self, param0)
        }

        let handler45: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::primary-icon-tooltip-markup",
            handler: gCallback(handler45)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPrimaryIconTooltipMarkup?(self, param0)
        }

        let handler46: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::primary-icon-tooltip-text",
            handler: gCallback(handler46)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyPrimaryIconTooltipText?(self, param0)
        }

        let handler47: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::progress-fraction",
            handler: gCallback(handler47)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyProgressFraction?(self, param0)
        }

        let handler48: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::progress-pulse-step",
            handler: gCallback(handler48)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyProgressPulseStep?(self, param0)
        }

        let handler49: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::scroll-offset",
            handler: gCallback(handler49)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyScrollOffset?(self, param0)
        }

        let handler50: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::secondary-icon-activatable",
            handler: gCallback(handler50)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySecondaryIconActivatable?(self, param0)
        }

        let handler51: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::secondary-icon-gicon",
            handler: gCallback(handler51)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySecondaryIconGicon?(self, param0)
        }

        let handler52: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::secondary-icon-name",
            handler: gCallback(handler52)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySecondaryIconName?(self, param0)
        }

        let handler53: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::secondary-icon-pixbuf",
            handler: gCallback(handler53)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySecondaryIconPixbuf?(self, param0)
        }

        let handler54: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::secondary-icon-sensitive",
            handler: gCallback(handler54)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySecondaryIconSensitive?(self, param0)
        }

        let handler55: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::secondary-icon-stock",
            handler: gCallback(handler55)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySecondaryIconStock?(self, param0)
        }

        let handler56: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::secondary-icon-storage-type",
            handler: gCallback(handler56)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySecondaryIconStorageType?(self, param0)
        }

        let handler57: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::secondary-icon-tooltip-markup",
            handler: gCallback(handler57)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySecondaryIconTooltipMarkup?(self, param0)
        }

        let handler58: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::secondary-icon-tooltip-text",
            handler: gCallback(handler58)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySecondaryIconTooltipText?(self, param0)
        }

        let handler59: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            ...
            handler: gCallback(handler59)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySelectionBound?(self, param0)
        }

        let handler60: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::shadow-type",
            handler: gCallback(handler60)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyShadowType?(self, param0)
        }

        let handler61: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::show-emoji-icon",
            handler: gCallback(handler61)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyShowEmojiIcon?(self, param0)
        }

        let handler62: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::tabs",
            handler: gCallback(handler62)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyTabs?(self, param0)
        }

        let handler63: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::text",
            handler: gCallback(handler63)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyText?(self, param0)
        }

        let handler64: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::text-length",
            handler: gCallback(handler64)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyTextLength?(self, param0)
        }

        let handler65: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::truncate-multiline",
            handler: gCallback(handler65)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyTruncateMultiline?(self, param0)
        }

        let handler66: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            ...
            handler: gCallback(handler66)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyVisibility?(self, param0)
        }

        let handler67: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            ...
            handler: gCallback(handler67)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyWidthChars?(self, param0)
        }

        let handler68: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::xalign",
            handler: gCallback(handler68)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyXalign?(self, param0)
        }

        let handler69: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
